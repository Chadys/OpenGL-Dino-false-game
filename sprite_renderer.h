...
public:
    ...
    SpriteRenderer(const Shader &shader, GLboolean isskybox, GLboolean is2d = GL_FALSE);
    // Destructor
    ~SpriteRenderer();
    ...
    void DrawSprite(const Texture2D &texture, glm::vec3 position, glm::vec2 size = glm::vec2(1.0f), GLfloat rotate = 0.0f, glm::vec3 rotation_angle = glm::vec3(0.0f,0.0f,1.0f), glm::mat4 projection = glm::mat4(), glm::mat4 view = glm::mat4());
