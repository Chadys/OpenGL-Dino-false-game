...
public:
    ...
    virtual void DrawSprite(StateManager &manager, const Tex &texture, glm::vec3 position, glm::vec3 size = glm::vec3(1.0f), GLfloat rotate = 0.0f, glm::vec3 rotation_angle = glm::vec3(0.0f,0.0f,1.0f), glm::vec3 color = glm::vec3(1.0f), GLfloat alpha = 1.0f, glm::mat4 projection = glm::mat4(), glm::mat4 view = glm::mat4());
    virtual void DrawSprite(StateManager &manager, const Tex &texture, glm::vec2 position, glm::vec2 size, GLboolean border = GL_FALSE, glm::mat4 projection = glm::mat4(), glm::mat4 view = glm::mat4(), GLboolean reversed = GL_FALSE, GLuint line = 0, GLuint col = 0, glm::vec2 sprite_size = glm::vec2(1));
