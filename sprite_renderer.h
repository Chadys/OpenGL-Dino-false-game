...
public:
    ...
    virtual void DrawSprite(const Tex &texture, glm::vec2 position, glm::vec2 size, GLboolean border = GL_FALSE, glm::mat4 projection = glm::mat4(), glm::mat4 view = glm::mat4(), GLboolean reversed = GL_FALSE, GLuint line = 0, GLuint col = 0, glm::vec2 sprite_size = glm::vec2(1));
    virtual void DrawSprite(const Tex &texture, glm::mat4 projection = glm::mat4(), glm::mat4 view = glm::mat4());
    void         DrawSprite(glm::vec2 position, glm::vec2 size, GLboolean isCircle, glm::vec3 color1, glm::vec3 color2, Effect effect, glm::mat4 projection = glm::mat4(), glm::mat4 view = glm::mat4(), GLboolean border = GL_FALSE);
