...
Object2D::Object2D(Texture2D sprite, glm::vec2 position)
    : GameObject(sprite), Position(position), Velocity(0), Reversed(GL_FALSE), Sprite_size(1), Action(IDLE), N_img(0) {
...
{
    renderer.DrawSprite(this->Tex, this->Position, this->Size, projection, view, this->Reversed, this->Action, (GLuint)this->N_img, this->Sprite_size);
}
