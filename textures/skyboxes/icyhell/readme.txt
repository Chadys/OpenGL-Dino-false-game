Date: 11/04/2001.
Title			Icy Hell
File:             sb-icyhelltga.zip
Author:           Techx 
Email:		techx@digitalarenas.com
Website:		http://techx.digitalarenas.com

--------------------------------------------------------
This is my third skybox release. Hope you like it!
...
Instructions for using the Icy Hell Skybox
--------------------------------------------
...
4. Close the file and open Q3Radiant and you should
   find on the texture menu the ICYHELL subdirectory.
   
5. Choose the ICYHELL subdirectory and you should find
   the sky texture ready for use.
   
6. If the editor displays 2 textures use the one
   called ICYHELL_SKYBOX. The other one is just so
