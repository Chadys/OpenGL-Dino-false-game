...
void Square::Draw(SpriteRenderer &renderer, glm::mat4 projection, glm::mat4 view, GLboolean border)
{
    renderer.DrawSprite(this->Position, this->Size, this->IsCircle, this->Color1, this->Color2, this->Effet, projection, view, border);
}
